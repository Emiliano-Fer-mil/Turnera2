...
namespace Turnera2.Controllers
{
    public class MedicoController : Controller
    {
        ...
        public MedicoController(ClinicaContexto context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MedicoId,Dni,NombreCompleto,Especialidad")] Medico medico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MedicoId,Dni,NombreCompleto,Especialidad")] Medico medico)
        {
